    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (res.success) {
                ...
                Alert.alert("Error", res.error || "Failed to add bank account.");
            }
        } catch (error) {
    ...
    return (
        <SafeAreaView className="flex-1 bg-white">
            <View className="flex-row items-center px-5 py-4 border-b border-neutral-100">
                ...
                <Text className="text-xl font-JakartaBold text-neutral-800 ml-4">Add Bank Account</Text>
            </View>
            ...
            <ScrollView className="p-5">
                ...
                >
                    {saving ? (
                        ...
                        <Text className="text-white font-JakartaBold text-lg">Save Bank Account</Text>
                    )}
                </TouchableOpacity>
            </ScrollView>
